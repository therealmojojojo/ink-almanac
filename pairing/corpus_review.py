...
# Shared logic (loading items + writing renderer inputs from a triplet) lives
# in pairing_inputs.py so the daily-publish path uses the same mapping.
from pairing_inputs import (  # noqa: E402
    SCHEMA_TEXT_FORMS, IMG_EXTS,
    load_yaml, load_items,
